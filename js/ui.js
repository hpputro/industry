...
function renderBuildPreview(buildingKey){
  ...
  if(def.category==='extractor'){
    ...
    html += `<br>Menambah populasi kota.<br>Levelnya naik otomatis jika bahan pendukung dan prasarana perumahan terpenuhi; turun otomatis jika dekat bangunan industri.<br>Insentif: +(Level-1) emas/putaran — makin tinggi levelnya, makin menguntungkan.`;
...
function renderDetail(i){
  ...
  if(def.category==='extractor'){
    ...
    html += `Menambah populasi kota: +${eff.pop}<br>Insentif: +${level-1} emas/putaran.<br><br>`;
